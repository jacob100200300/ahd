% This code generates a network of n nodes with random positions,
...
% Initialize the number of nodes (n), distance threshold, and separator
n = 150;
...
filename = ['network_data_', num2str(n), '_', current_datetime, '.xlsx'];
